...
<br>
<br>
      <center><img src="kit.png" alt="Simply Easy Learning" width="200" height="100"></center>
   </body>
</html>
	<p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'KALAIGNAR KARUNANIDHI INSTITUTE OF TECHNOLOGY - Payment Of Term Fees' ?></b></p>
	<hr>
	<div class="flex">
		<div class="w-50">
			<p>Register No: <b><?php echo $ef_no ?></b></p>
			<p>Student: <b><?php echo ucwords($sname) ?></b></p>
			<p>DEPT: <b><?php echo $class ?></b></p>
                                                <p>Receipt Number: <b><?php echo isset($pay_arr[$_GET['pid']]) ? $pay_arr[$_GET['pid']]['id']: '' ?></b></p>
		</div>
		<?php if($_GET['pid'] > 0): ?>
		<div class="w-50">
	...
	<table class="wborder">
		...
		<tr>
			<td width="50%">
				<p><b>Sign.Of Staff:</b></p>
                                               <hr>
                                                                 <p><b>Sign.Of Reciever:</b></p>
				</table>
				</table>
			</td>			
		</tr>
	</table>
                <p>@Grade 11 students 2021-22
</div>
<br>
<br>
